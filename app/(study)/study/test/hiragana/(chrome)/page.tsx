    ...
    <div className="min-h-screen px-4 py-10">
      <div className="mx-auto w-full max-w-[640px]">
        ...
        <div className="mb-7 text-[0.9rem] leading-[1.6] text-text-muted">
          <p className="">
            Type the romaji reading for each sentence below, then press Check to
            see it.
          </p>
          <p className="">
            Because of certain grammar rules you&apos;ll learn later on, some
            characters are read differently than usual — that&apos;s why
            you&apos;ll find their correct reading written above them, as a
            little hint.
          </p>
          <p>
            Quick note: &quot; 、&quot; and &quot; 。&quot; are Japanese punctuation marks — they
            work just like a comma and a period.
          </p>
        </div>
