...
export function WordPreviewRow({ vocabulary, renderKanji }: Props) {
  return (
    <div className="flex items-center gap-3 px-3 py-2.5">
      <div className="shrink-0 pt-[0.4em] text-3xl leading-none">
        {renderWordWithFurigana(vocabulary.word, vocabulary.furiganas, undefined, undefined, undefined, renderKanji)}
      </div>
