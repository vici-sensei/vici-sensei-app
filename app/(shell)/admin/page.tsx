  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <Link href="/admin/jmdict-senses">
          <GlassCard padding="sm" className="flex items-center gap-4 transition-colors hover:bg-white/[0.03]">
            <FaBook className="h-6 w-6 text-accent-red" />
            <div>
              <div className="font-bold">Sensuri JMdict</div>
              <div className="text-sm text-text-muted">Alege sensurile principale/secundare pentru cuvintele semnalate</div>
            </div>
          </GlassCard>
        </Link>
      </div>
