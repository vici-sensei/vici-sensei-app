...
import { FcGoogle } from 'react-icons/fc'; // Importăm iconița oficială Google perfectă

// Inițializăm clientul de Supabase direct pe frontend[cite: 1]
...
export default function LoginPage() {
  const handleGoogleLogin = async () => {
    await supabase.auth.signInWithOAuth({
      provider: 'google',
      options: {
        // Trimite userul pe localhost la callback după logarea cu Google[cite: 1]
  ...
  return (
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#0d1117] px-4 text-white font-sans antialiased">
      ...
      <div className="w-full max-w-md space-y-8 rounded-2xl border border-zinc-700/50 bg-[#161b22] p-8 shadow-2xl">
        ...
        <div className="mt-8">
          {/* BUTONUL stil capsulă: fundal închis, text și bordură roșu-coral distins */}
          <button
          ...
          >
            {/* Noua iconiță din librărie - randare perfectă pe orice ecran, dimensiune fixă 20px */}
